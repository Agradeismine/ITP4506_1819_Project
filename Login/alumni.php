...
<body onload="myFunction()" >
    ...
    <div class="navbar">
        ...
        <img src="images/alumniIcon.png" style="float:right; width:45px; height:45px;">
    ...
    <section>
        ...
        <span id="margin">
            ...
            <div id="contentType">
                  <form class="reseter">
                   <input type="checkbox" name="contentType" value="Magazine"> <a href="alumni.php?Magazine">Magazine Article </a><br>
                   <input type="checkbox" name="contentType" value="Software"><a href="alumni.php?Software">Software </a><br> 
                    <input type="checkbox" name="contentType" value="Book"><a href="alumni.php?Book">Book / eBook </a><br>
                    </form>
            </div>
            <h2>Discipline</h2>
            <div id="Discipline">
               <form class="reseter">
                <input type="checkbox" name="Discipline" value="Technology"> <a href="alumni.php?Technology">Technology</a><br>
                <input type="checkbox" name="Discipline" value="History"> <a href="alumni.php?History">History</a><br>
                <input type="checkbox" name="Discipline" value="Education"> <a href="alumni.php?Education">Education</a><br>
                <input type="checkbox" name="Discipline" value="Leisure"> <a href="alumni.php?Leisure">Leisure</a><br>
                <input type="checkbox" name="Discipline" value="Music"> <a href="alumni.php?Music">Music</a><br>
                <input type="checkbox" name="Discipline" value="Business"> <a href="alumni.php?Business">Business</a><br>
                <input type="checkbox" name="Discipline" value="Comic"> <a href="alumni.php?Comic">Comic</a><br>
                </form>
            </div>
            <h2>Language</h2>
            <div id="Language">
         ...
         <div id="course">
          ...
          <div id="zone">
             <br>
              <input class="filter" type="button" onclick="hrefLink('alumni.php')" value="Applyfilters">
