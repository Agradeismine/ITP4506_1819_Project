...
<body>
    ...
    <div id="details">
      ...
      <b style="color:orange;">Click to Preview</b>
       <img class="thumbnail"  src="2.jpg" height="150px" width="165px" id="preview"> 
       <div class="button">
       ...
       <div id="title">She's the one: 7 smash hits</div>
       Author A<br>
       2004<br>
       ISBN: 21796247
       ...
       <div class="send" id="getDiv">
           ...
           <p style="color:darkgreen;" id="available">
            ...
            <div id="success" style="text-align:center; color:black; background-color:red;float: left; width:65%; height:200px;">
                 <br> <br><b>Your request was unsuccessfully placed</b><br>
                         <b>You have exceeded the reserving book limit!</b><br>
                         <br>
                 <div>
                 <br>
                    <br>
               ...
               <div id="Nsuccess" style="text-align:center; color:black; background-color:red;float: left; width:65%; height:200px;">
                 <br> <br><b>Your request was unsuccessfully placed</b><br>
                         <b>You have exceeded the reserving book limit!</b><br>
                 <div>
                    <br>
           ...
           <p style="color:black;">
               <b>Title</b>   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; She's the one: 7 smash hits <br>
               <b>Author</b>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Author A<br>
               
               <b>Language</b>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;English<br>
               <b>Publisher</b>  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;University of California Press<br>
               <br>
                <b>Description</b> <br> To purchase music just find the item or items of interest and place them in the shopping basket. We post to any country. Payment can be made in any currency via Paypal, or any credit/debit card, including American Express, using Worldpay. People with UK Bank accounts may also pay by cheque in UK Pounds. 
              </div>
